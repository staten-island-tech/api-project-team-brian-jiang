export async function giantBombInit() {
  try {
    ...
    let game = await fetch(`https://cors-anywhere.herokuapp.com/https://www.giantbomb.com/api/game/${result.results[0].id}/?api_key=ba31dd109b521b66607178ada5c6b8f4fc13ca0b&field_list=name,id,characters,developers,locations,platforms,objects,releases&format=json`);
